...
const Last_One = () => {
  return (
    <div className="py-5">
      <Row>
        <Col xs={12} sm={6} md={4} lg={3} className=" pt-3 ">
          <h2 className="ff-poppins fw_500 fs_44 fc_blue mb-0 ">Jadoo.</h2>
          <p className="ff-poppins fw_500 fs_13 fc_off_black mb-0 footer_para1">
            Book your trip in minute, get full Control for much longer.
          </p>
        </Col>
        <Col xs={12} sm={6} md={4} lg={2} className=" pt-3 ">
          <ul className="ps-0">
            <li className="ff-poppins fs_21 fw_700  fc_main_black mb-0 pb-4">
              Company
            </li>
            <li>
          ...
          <div>
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      ...
                      result="effect1_dropShadow_1722_653"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_1722_653"
                      result="shape"
                    />
                  </filter>
                </defs>
            ...
            <Link className="instagram d-inline-block">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g filter="url(#filter0_d_1722_656)">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                ...
                <g clip-path="url(#clip0_1722_656)">
                  ...
                  <path
                    className="fill_4"
                    d="M38.6562 22H27.3438C26.0516 22 25 23.0516 25 24.3438V35.6562C25 36.9488 26.0516 38 27.3438 38H38.6562C39.9488 38 41 36.9488 41 35.6562V24.3438C41 23.0516 39.9488 22 38.6562 22ZM40.0625 35.6562C40.0625 36.4316 39.4316 37.0625 38.6562 37.0625H27.3438C26.5684 37.0625 25.9375 36.4316 25.9375 35.6562V24.3438C25.9375 23.5684 26.5684 22.9375 27.3438 22.9375H38.6562C39.4316 22.9375 40.0625 23.5684 40.0625 24.3438V35.6562Z"
                    fill="black"
                  />
                  <path
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_1722_656"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_1722_656"
                      result="shape"
                    />
                  </filter>
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_1722_650"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_1722_650"
                      result="shape"
                    />
                  </filter>
                </defs>
      ...
      <h2 className="ff-poppins fc_off_black  fs_14 fw_500 mb-0 text-center pt-5  pb-3">
